...
namespace CLValidator
{
    public class EmployeeFieldChecker
    {
        ...
        public async Task<bool> Check(Employee employee)
        {
            ...
            if (await fieldCheck.checkForbinddenStringCharacters(forbiddenCharacters, employee.Name) == false)
            {
                fejlMeddelelseIncrementer("Name had forbidden characters");
                validationResult = false;
            }
            if (await fieldCheck.checkForbinddenStringCharacters(forbiddenCharacters, employee.Address) == false)
            {
                fejlMeddelelseIncrementer("Address had forbidden characters");
                validationResult = false;
            }
            ...
            if (await fieldCheck.checkForbinddenStringCharacters(forbiddenCharacters, employee.Company) == false)
            {
                fejlMeddelelseIncrementer("Company had forbidden characters");
                validationResult = false;
            }
            if (await fieldCheck.checkForbinddenStringCharacters(forbiddenCharacters, employee.Department) == false)
            {
                fejlMeddelelseIncrementer("Department had forbidden characters");
                validationResult = false;
            }
